...
def make_w_coreg_7T():
    ...
    n_coreg.inputs.sampling_percentage = [0.25, ]
    n_coreg.inputs.sigma_units = ['vox', ]
    n_coreg.inputs.convergence_threshold = [1e-6, ]
    n_coreg.inputs.smoothing_sigmas = [[4, 2, 0], ]
    n_coreg.inputs.shrink_factors = [[5, 3, 1], ]
    n_coreg.inputs.convergence_window_size = [20, ]
    n_coreg.inputs.number_of_iterations = [[1000, 500, 200], ]
